...
public class UpdateInstance {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		 ...
		 driver.switchTo().frame(0);
		 WebElement findElement5 = driver.findElement(By.xpath("//select [@id='incident.urgency']"));
		 String attribute = findElement5.getAttribute("value");
		 System.out.println(attribute);
		 driver.switchTo().defaultContent();
		
		 if(attribute.equals(se)) {
		 ...
		 driver.switchTo().frame(0);
		 WebElement findElement6 = driver.findElement(By.xpath("//select[@id='incident.state']"));
